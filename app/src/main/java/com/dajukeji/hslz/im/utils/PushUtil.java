...
public class PushUtil implements Observer {
    ...
    private void PushNotify(TIMMessage msg){
        ...
        MLog.INSTANCE.d(TAG, "recv msg " + contentStr);
        NotificationManager mNotificationManager = (NotificationManager) AliSdkApplication.getContext().getSystemService(AliSdkApplication.getContext().NOTIFICATION_SERVICE);
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(AliSdkApplication.getContext());
        Intent notificationIntent = new Intent(AliSdkApplication.getContext(), MainActivity.class);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP
                | Intent.FLAG_ACTIVITY_SINGLE_TOP);
        PendingIntent intent = PendingIntent.getActivity(AliSdkApplication.getContext(), 0,
...
//                .setNumber(++pushNum) //设置通知集合的数量
    ...
    public void reset(){
        NotificationManager notificationManager = (NotificationManager)AliSdkApplication.getContext().getSystemService(AliSdkApplication.getContext().NOTIFICATION_SERVICE);
