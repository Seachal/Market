...
public class FileMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        TextView tv = new TextView(AliSdkApplication.getContext());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(AliSdkApplication.getContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        return AliSdkApplication.getContext().getString(R.string.summary_file);
    }
