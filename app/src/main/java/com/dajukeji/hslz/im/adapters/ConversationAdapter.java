...
import com.dajukeji.hslz.im.utils.TimeUtil;
...
public class ConversationAdapter extends ArrayAdapter<Conversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvName.setText(data.getNickName()); // 设置用户名称
        if(!TextUtils.isEmpty(data.getFaceUrl())){ // 设置用户头像
            GlideEngine.loadImage(getContext(), R.drawable.head_other, viewHolder.avatar, data.getFaceUrl());
        }else{
