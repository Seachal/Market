...
public class SessionListActivity extends BaseActivity implements ConversationView, GroupManageMessageView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) this.findViewById(R.id.session_listView);
        adapter = new ConversationAdapter(this, R.layout.item_conversation, conversationList);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                conversationList.get(position).navToDetail(SessionListActivity.this);
