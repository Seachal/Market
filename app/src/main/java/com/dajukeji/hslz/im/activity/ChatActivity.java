...
import com.dajukeji.hslz.im.model.FileMessage;
import com.dajukeji.hslz.im.model.ImageMessage;
import com.dajukeji.hslz.im.model.Message;
import com.dajukeji.hslz.im.model.MessageFactory;
import com.dajukeji.hslz.im.model.TextMessage;
...
//    private Toolbar mToolBar;
    ...
    public static void navToChat(Context context, String identify, TIMConversationType type, String nickname){
        Intent intent = new Intent(context, ChatActivity.class);
        intent.putExtra("identify", identify);
        intent.putExtra("type", type);
    ...
    public static void navToChat(Context context, String identify, TIMConversationType type, String faceUrl, String nickname){
        Intent intent = new Intent(context, ChatActivity.class);
        intent.putExtra("identify", identify);
        intent.putExtra("type", type);
...
//        initToolBar();
        ...
        title_bar_title.setText(nickname);
        presenter = new ChatPresenter(this, identify, type);

        initListView();

        input.bindToContentView(listView);
...
//        mToolBar = (Toolbar) this.findViewById(R.id.chat_toolBar);
...
//    }
    ...
    private void initListView(){
        adapter = new ChatAdapter(this, R.layout.item_message, messageList, faceUrl);
        ...
        if (message == null) {
            ...
            if (mMessage != null) {
                if (mMessage instanceof CustomMessage){
                    ...
                    switch (messageType){
                        case TYPING:
//                            mToolBar.setTitle(getString(R.string.chat_typing));
