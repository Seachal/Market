...
public class FriendOrZonePopuWindow extends PopupWindow {
    private View conentView;
    private String pick_url;
    public FriendOrZonePopuWindow(final Activity context ,final  String pick) {

        this.pick_url =pick;

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.popuwindow_share_friend_or_zone, null);
