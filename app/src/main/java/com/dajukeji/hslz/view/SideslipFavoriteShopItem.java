 ...
 * 收藏侧滑
 * */
public class SideslipFavoriteShopItem extends RecyclerView {
    ...
    public SideslipFavoriteShopItem(Context context) {
        this(context, null);
    }

    public SideslipFavoriteShopItem(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SideslipFavoriteShopItem(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    mPosition =  getChildViewHolder(view).getAdapterPosition();
                    FavoriteShopFragment.ValidViewHolder viewHolder = (FavoriteShopFragment.ValidViewHolder) getChildViewHolder(view);
                    mItemLayout = viewHolder.ll_favorite_item;
                    mDelete = (TextView) mItemLayout.findViewById(R.id.tv_invialid_delete);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int scrollX = 0;
                try {
                    scrollX = mItemLayout.getScrollX();
                } catch (Exception e1) {
                    break;
                }
