...
package com.dajukeji.hslz.view.tablayout;
...
public class SelfAdaptionTabLayout extends HorizontalScrollView {
    ...
    public SelfAdaptionTabLayout(Context context) {
        this(context, null);
    }

    public SelfAdaptionTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelfAdaptionTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        //获取颜色
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SelfAdaptionTabLayout);

        //选中与未选中的颜色
        mTabSelectedTextColor = typedArray.getColor(R.styleable.SelfAdaptionTabLayout_tabSelectedTextColor, 0);
        mTabTextColor = typedArray.getColor(R.styleable.SelfAdaptionTabLayout_tabTextColor, 0);

        //选中下划线的粗细
        int selectedIndicatorThickness = (int) typedArray.getDimension(R.styleable.SelfAdaptionTabLayout_tabIndicatorThickness, SELECTED_INDICATOR_THICKNESS_DIPS);
        //选中的下划线的颜色
        int tabIndicatorColor = typedArray.getColor(R.styleable.SelfAdaptionTabLayout_tabIndicatorColor, DEFAULT_SELECTED_INDICATOR_COLOR);

        //tab之间的中间分割线的粗细
        int tabDividerThickness = (int) typedArray.getDimension(R.styleable.SelfAdaptionTabLayout_dividerThickness, DEFAULT_DIVIDER_THICKNESS_DIPS);
        //tab之间的中间分割线颜色
        int tabDividerColor = typedArray.getColor(R.styleable.SelfAdaptionTabLayout_dividerColor, defaultBackgroundColor);

        //tab底部的下划线的背景后面的粗细与颜色
        int tabBottomBorderThickness = (int) typedArray.getDimension(R.styleable.SelfAdaptionTabLayout_bottomBorderThickness, DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS);
        int tabBottomBorderColor = typedArray.getColor(R.styleable.SelfAdaptionTabLayout_bottomBorderColor, defaultBackgroundColor);

        //是否显示tab中间的分割线，这里默认不显示
        boolean showAsDivider = typedArray.getBoolean(R.styleable.SelfAdaptionTabLayout_showAsDivider, false);
...
//        mTitleOffset = (int) (TITLE_OFFSET_DIPS * getResources().getDisplayMetrics().density);
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link SelfAdaptionTabLayout} you are
