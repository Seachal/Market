...
class SlidingTabStrip extends LinearLayout {
    ...
    private SelfAdaptionTabLayout.TabColorizer mCustomTabColorizer;
    ...
    void setCustomTabColorizer(SelfAdaptionTabLayout.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final SelfAdaptionTabLayout.TabColorizer tabColorizer = mCustomTabColorizer != null
                ? mCustomTabColorizer
    ...
    private static class SimpleTabColorizer implements SelfAdaptionTabLayout.TabColorizer {
