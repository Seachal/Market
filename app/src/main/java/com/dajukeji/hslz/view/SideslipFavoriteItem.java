 ...
 * 收藏侧滑
 * */
public class SideslipFavoriteItem extends RecyclerView {
    ...
    public SideslipFavoriteItem(Context context) {
        this(context, null);
    }

    public SideslipFavoriteItem(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SideslipFavoriteItem(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    FavoriteGoodsFragment.ValidViewHolder viewHolder = (FavoriteGoodsFragment.ValidViewHolder) getChildViewHolder(view);
