...
/**
 * Created by ${wangjiasheng} on 2018/1/12 0012.
 */
...
//            if (((GridLayoutManager) manager).getOrientation() == LinearLayoutManager.VERTICAL) {
//                if (itemPosition%spanCount == 0) {
//                    outRect.set(mDividerHeight, mDividerHeight, mDividerHeight, 0);
//                } else {
//                    outRect.set(mDividerHeight, mDividerHeight, 0, 0);
//                }
//            } else if (((GridLayoutManager) manager).getOrientation() == LinearLayoutManager.HORIZONTAL){
//                if (itemPosition%spanCount == 0) {
