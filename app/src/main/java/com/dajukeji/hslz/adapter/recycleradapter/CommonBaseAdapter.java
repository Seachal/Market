...
import com.dajukeji.hslz.adapter.recycleradapter.interfaces.OnItemChildClickListener;
import com.dajukeji.hslz.adapter.recycleradapter.interfaces.OnItemClickListener;
import com.dajukeji.hslz.adapter.recycleradapter.interfaces.OnSwipeMenuClickListener;
...
public abstract class CommonBaseAdapter<T> extends BaseAdapter<T> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (isCommonItemView(viewType)) {
            bindCommonItem(holder, position - getHeaderViewCount());
        }
    }
