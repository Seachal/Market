...
import com.dajukeji.hslz.adapter.recycleradapter.interfaces.OnLoadMoreListener;
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int TYPE_HEADER_VIEW = 100006;//头部
    ...
    private RelativeLayout mHeaderLayout;//header view
    private boolean mOpenHeaderView;
    ...
    public int getItemViewType(int position) {
        ...
        return getViewType(position, mDatas.get(position - getHeaderViewCount()));
    }
    ...
    private boolean isHeaderView(int position){
        return mOpenHeaderView && position == 0;
    }
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        //StaggeredGridLayoutManager模式时，HeaderView可占据一行
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    if (!isAutoLoadMore && findLastVisibleItemPosition(layoutManager) + 1 == getItemCount() && findFirstVisibleItemPosition(layoutManager) != 0) {
                        isAutoLoadMore = true;
                        scrollLoadMore();
                    }
                }
...
//                }
                ...
                //isAutoLoadMore已改为用来防止一直上滑，同时间刷新多次的标识
    ...
    private int findFirstVisibleItemPosition(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof LinearLayoutManager) {
            ...
            return Util.findMin(lastVisibleItemPositions);
        }
        return -1;
    }
    ...
    private void addHeaderView(View headerView) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
        mHeaderLayout.addView(headerView, params);
    }
...
//        notifyItemInserted(0);
    ...
    public void setHeaderView(int loadingId) {
        setHeaderView(Util.inflate(mContext, loadingId));
    }

    public void setOpenHeaderView(boolean openHeaderView){
        this.mOpenHeaderView = openHeaderView;
    }
    ...
    public void setDataToFirst(T data){
        mDatas.add(0, data);
        notifyDataSetChanged();
    }
