...
public class HealthArticleListFragment extends HttpBaseFragment {
    ...
    public HealthArticleListFragment(){
    ...
    private void loadList(int page) {
        showDialogLoading();
        articlePresenter.getHealthArticleList(getContext(),page,DataType.myPresenterType.getHealthArticleList.toString());
    }
