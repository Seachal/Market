...
public class DownloadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            while ((byteread = in.read(buffer)) != -1) {
                ...
                MLog.INSTANCE.w(TAG, "下载中 - " + bytesum);
            ...
            MLog.INSTANCE.e(TAG, "download apk file error:" + e.getMessage());
        } finally {
            if (out != null) {
                try {
                    out.close();
    ...
    private Uri getApkUri(File apkFile) {
        MLog.INSTANCE.d(TAG, apkFile.toString());
        ...
        MLog.INSTANCE.d(TAG, uri.toString());
