 ...
 * 叠加布局
 */
public class SuperpositionLayout extends ViewGroup {
    ...
    public SuperpositionLayout(Context context) {
        this(context, null, 0);
    }

    public SuperpositionLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SuperpositionLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SuperpositionLayout);
        vertivalSpace = ta.getDimension(R.styleable.SuperpositionLayout_verticalSpace, dp2px(4));
        pileWidth = ta.getDimension(R.styleable.SuperpositionLayout_superpositionWidth, dp2px(10));
        ta.recycle();
    }
