package com.dajukeji.hslz.red.meteorshower;
...
import com.dajukeji.hslz.util.DensityUtil;
...
public class BoomSprite extends BaseSprite {
    ...
    public BoomSprite(Context context, int pWidth, int pHeight){
        ...
        Bitmap bmp = BitmapFactory.decodeResource(context.getResources(), R.drawable.popwindow_close);
