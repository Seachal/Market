...
public class NormalGoodDetailActivity extends HttpBaseActivity {
    ...
    private String goods_id_webActivity;//配合兑换专区的商品id传递
    ...
    protected void initView() {
        ...
        //配合兑换专区的跳转
        //从这里做activity判断，如果是从h5页面来的商品id，就从里做好商品id变更
        if (!goods_id_webActivity.equals("")){
            goods_id = Integer.parseInt(goods_id_webActivity);
        }
...
//        goods_detial_tab = (ImageView) findViewById(R.id.goods_detial_tab);
        ...
        goods_detail_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                //配合兑换专区
                if (!goods_id_webActivity.equals("")){
                    goodPresenter.getExchangeGoodDetail(NormalGoodDetailActivity.this, goods_id, DataType.myPresenterType.getGoodDetail.toString());
                }else {
                    goodPresenter.getGoodDetail(NormalGoodDetailActivity.this, goods_id, DataType.myPresenterType.getGoodDetail.toString());
                }
...
//                }
            ...
            case R.id.goods_detail_share_ll:
                startActivity(new Intent(NormalGoodDetailActivity.this, MainActivity.class));
                break;
...
//            }
    ...
    private void selectSku(final String tag) {
        ...
        */
        ...
        skuDialog.setGoods_id_webActivity(goods_id_webActivity);//配合兑换专区的更新
        skuDialog.builder();
        Gson gson = new Gson();
        //如果点击确定下单
        skuDialog.show();
        ...
        skuDialog.setOnSelectListener(new SkuDialog.onSelectListener() {
            ...
            public void onComplete(long goodId, int count, String sku, String goodPrice) {
                ...
                if (tag.equals("add_to_shopcart")) {
                    //配合兑换专区的商品更新
                    if (!goods_id_webActivity.equals("")){
                        return;
                    }
                    goodPresenter.addToCart(NormalGoodDetailActivity.this, goodId + "", count + "", sku, buyType1, DataType.good.addToCart.toString());
                } else if (tag.equals("sure_buy")) {
                    Intent intent = new Intent(NormalGoodDetailActivity.this, OrderEditActivity.class);
                    Bundle bundle = new Bundle();
...
//                        startActivity(new Intent(NormalGoodDetailActivity.this,DuiOrderEditActivity.class));
//                        return;
                    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        OkGo.getInstance().cancelTag(NormalGoodDetailActivity.this);
    }
}
