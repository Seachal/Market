...
public class EmotionGridViewAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		iv_emotion.setTextSize(20);
		iv_emotion.setTextColor(ContextCompat.getColor(context, R.color.black));

		iv_emotion.setGravity(Gravity.CENTER);
		...
		if(position == getCount() - 1) {
			iv_emotion.setBackgroundResource(R.drawable.ic_emojis_delete);
		} else {
			iv_emotion.setText(emotionNames.get(position));
		}
