...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public void initIndicator(int count){
        ...
        for (int i = 0 ; i<count ; i++){
            ...
            if (i == 0){
                v.setBackgroundResource(R.drawable.bg_indicator_point_select);
            }else{
                v.setBackgroundResource(R.drawable.bg_indicator_point_nomal);
            }
            mImageViews.add(v);
            this.addView(v);
        }
    ...
    public void playByStartPointToNext(int startPosition,int nextPosition){
        ...
        ViewNext.setBackgroundResource(R.drawable.bg_indicator_point_select);
        ViewStrat.setBackgroundResource(R.drawable.bg_indicator_point_nomal);
    }
